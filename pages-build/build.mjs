    ...
    hero: {
      ...
      plan: {
        ...
        doneItems: [
          ...
          'WebUI 統一エントリ（2026-08-30）— ランディング（日/中）/ PF Dashboard 同梱 <code>/pf/</code> / <code>/shared</code> テーマ配信',
          '共通デザインシステム（2026-08-30）— 全 UI を暗色 + グリーンで統一（token 集約・チャート色統一）',
          'コンソール拡充（2026-08-30）— 棚卸しダッシュボード / 閲覧ズーム・CSV / 分析チャート / イベント一括削除 / 辞書編集',
        ],
        todoItems: [
    ...
    hero: {
      ...
      plan: {
        ...
        doneItems: [
          ...
          'WebUI 统一入口（2026-08-30）— 落地页（日/中）/ PF Dashboard 同捆 <code>/pf/</code> / <code>/shared</code> 主题分发',
          '统一设计系统（2026-08-30）— 全 UI 暗色 + 绿色统一（token 集中、图表色统一）',
          'Console 功能扩展（2026-08-30）— 库存看板 / 浏览缩放·CSV / 分析图表 / 事件批量删除 / 字典编辑',
        ],
        todoItems: [
