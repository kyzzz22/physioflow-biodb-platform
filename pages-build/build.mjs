  ...
  ja: {
    ...
    hero: {
      ...
      plan: {
        ...
        doneTitle: '✅ 完了（BioDB 側 + PF 側 D1〜D2）',
        todoTitle: '🚧 未開発（PF 側 D3〜D10）',
        doneItems: [
        ...
        todoItems: [
          '短期：D3 データ管理パネル → D4 データ辞書 → D5 脳波デバイス adapter',
          '中期：D7 分析パイプライン → D8 可視化 → D6 結合エクスポート',
  ...
  zh: {
    ...
    hero: {
      ...
      plan: {
        ...
        doneTitle: '✅ 已完成（BioDB 侧 + PF 侧 D1~D2）',
        todoTitle: '🚧 待开发（PF 侧 D3~D10）',
        doneItems: [
        ...
        todoItems: [
          '短期：D3 数据管理面板 → D4 数据字典 → D5 脑波设备 adapter',
          '中期：D7 分析管线 → D8 可视化 → D6 联合导出',
