  ...
  ja: {
    ...
    hero: {
      ...
      plan: {
        ...
        doneTitle: '✅ 完了（BioDB 側 + PF 側 D1〜D4・D6・D7）',
        todoTitle: '🚧 未開発（PF 側 D8〜D10）',
        doneItems: [
  ...
  zh: {
    ...
    hero: {
      ...
      plan: {
        ...
        doneTitle: '✅ 已完成（BioDB 侧 + PF 侧 D1~D4、D6、D7）',
        todoTitle: '🚧 待开发（PF 侧 D8~D10）',
        doneItems: [
